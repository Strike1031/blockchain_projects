...
const INFURA_URL =
  process.env.MAINNET_RPC_URL || `https://eth-mainnet.g.alchemy.com/v2/${process.env.INFURA_KEY}`
const INFURA_WS_URL =
  process.env.MAINNET_WS_URL || `wss://eth-mainnet.g.alchemy.com/v2/${process.env.INFURA_KEY}`
...
const CORS_SETTINGS = {
  ...
  // oring: ['https://harvest-finance.netlify.app']
...
const MATIC_RPC_URL =
  ...
  `https://polygon-mainnet.g.alchemy.com/v2/${process.env.MATIC_INFURA_KEY}`
