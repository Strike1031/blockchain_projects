...
/*
                           ...
                           -o///::::::::::-o.                                                             `.-.`                                       
                            .++//:::::::::::+                                                                `--.`                                    
                             `o//::::///++//o-...``                                                  `.:///:`  `.--`                                  
                              `s//::+sooooss+///////:.``       ```    `-://`.-:-.`   `.::////:-.```-///::::/o`    `--`                                
                              `s//::://///s:::::::::::///-`` `:+++/../++/++::---::/:++ooooossoooo+//:::::::::o      `--`                              
                            `--s/:::::::::s:::::::::::::-:///oossso+ooss/--------+ooosyhhhhhhhy+/:::::/+++::-o.       `:-                             
                           .:. s/:::::::::s:::/+/++++/::::::-:+syssssy+--:://///ssoyhhhhhhhhs/::::::/o+-.+/:::/         .:.                           
                         `:-  :o/:::::::::s:::o.```.-/+o+/:::::-:+syy+//+sos::ooooo/ysysyho/:::::/+o/.```:+::-o           -:                          
                        .:`  `s//::::::::/y::://```````.-/+o/:::::-/+/:::+ooo::s++s//soo:::::::+oo:``````-+::-o            `:`                        
                       -:    ++/::::::::////:::o```````````-so::::::::::::+os::/s++s:+so::::::/ss-```````:+::-o              :-                       
                      :-    -o//::++o+++: .o:::+-```````./++:::::::::::::::/o:::+o+o/::::::::::::++:`````//::-s               -:                      
                     :.     o//:::/ooos-   s::::o`````./+/:::::::::::::::::::::::ooo+::::::::::::::/+:.``+:::-s                .:                     
                   `:.     /+//:::::-/:   :so::://``./+/::::::::::::::::::::::::::oo:::::::::::::::::/+:`o:::-o                 .:                    
                   :.     `s///::::::/  `+s+s/:::o--+/:::::::::::::::::::::::::::::::::::::::::::::::::/+o::::/                  .:                   
                  :-      -o//:::::-o` `+s/:oy::::o+::::::::::::::::::::::::::::::::::::::::/oyo:::::::::/::-+:`                  -:                  
                 -:       /+///::///o `o++o/yyo:::/::::::::::::::::+so/:::::::::::::::::::::dMMMd/::::::::::-s://-                 :.                 
                `/        +////:+ssss`oys+o+//+o::::::::::::::::::hMMMNs::::::::::::::::::--+sMMMs::::::::::/s/::o                 `/`                
                :.        /+///:://:/sso/:-:/oos:::::::::::::::-.-+sMMMMs:::::::::::::::::-:ydMMMh:::::::::::ss/:+                  .:                
               .:         .s////:::/+/---:osyyy/:::::::::::::::.`.+yMMMMN::::::::::::::::::/mNNNNs:::::::::/::s/:+.`                 :.               
               /`          ++////::o----+sshhh/:::::::::::::::::::mMMNNNd::::::::::::::::::://///:::::::+++//::so///:                `/               
              `:           `o/////:o---+syhhho::::::::::::::::::::/so+/:::::::::::::::/:::::::::::::::+o/:::::-+ys:/:                 /`              
              :.            `o+////s/oyyshhhy:::::::+++//:::::::::::::::::::::::::+/::::+:::::::::::::++++++++:-s+:o                  .-              
              /               /o///yysyohhhh+:::::::::://++++:::::::::::::::::::::o-----+:::::::::::::://::::::-:ooy.                 `/              
             ...
             --                    so++osyy::::::::::::::+/:::::::::::::::///++///:::::::::::::::::::::::::::::++:++/                  --             
             --                    o//+osss::::::::::::::::::::::::::::::::::::::::///////::::::::::::::::::::::/o+:                   --             
             --                   .oo//ssss::::/o:::::::::::::::::::::::::::://+oooooooooooo+/::::::/:::::::::::::o.                   --             
             --                  `o:o+syssy:::/o/::::::::::::::::::::::::::+ooo+++++++++++++oo+::://o/::::::::::::-+`                  --             
             --                  :/..oyyyys::/s:::::::::::::::::+/:::::::/oo+++++++++++ooooooos+//:o.+/:::::::::-.`.+                  --             
         ````--                  +:```:oss///s/::::::::::::::::/o::::::::soo+++++oo+++/:++:::-...--o `+/::::--..````+                  --````         
    `.---.....`                  :/`````.-::s/:::::::::::::::::o:::::----:---...``       -/:---..-+:  `/:..```````-`+                  `.....---.`    
  `--.                            +:.``````.s`.-::::::::::::::o`                           .-://::-     ./-.``.```-//                           .--`  
 .:`                               :::-/:::+/```.--:::::::::/+`                                           -:/-:-.-/:                              `:. 
...
contract TACOCAT_Token is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xd82e16aEE41a39746c68BF03dEF03787E593fa5d); // Marketing Address
    ...
    string private _name = "TACOCAT Token";
    string private _symbol = "TCT";
    ...
    function _transfer(
        ...
        require(!_isBlacklisted[from], "Blacklisted address in tx");
        if(from != owner() && to != owner()) {
            require(amount <= _maxTxAmount, "Transfer amount exceeds the maxTxAmount.");
        }
        
        if(!_isFree[to]) {
            require(balanceOf(to) < _maxWallet);
        }
    ...
    function setFree(address account) public onlyOwner {
        _isFree[account] = true;
    }
    
    function unSetFree(address account) public onlyOwner {
        _isFree[account] = false;
    }    

    function checkFree(address account) public view onlyOwner returns(bool){
